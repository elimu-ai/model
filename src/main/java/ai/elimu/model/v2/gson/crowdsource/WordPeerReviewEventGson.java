...
public class WordPeerReviewEventGson extends BaseEntityGson {
    ...
    private WordContributionEventGson wordContributionEvent;
    ...
    public WordContributionEventGson getWordContributionEvent() {
        return wordContributionEvent;
    }

    public void setWordContributionEvent(WordContributionEventGson wordContributionEvent) {
